...
from .serializers_centre import BookingSerializer, HallSerializer
...
from .serializers import (  
    ...
    UserLoginSerializer,PaymentTransactionSerializer ,    
)
...
class EventCentreListCreateApiView(generics.ListCreateAPIView):
    queryset = EventCentre.objects.all()
    serializer_class = EventCentreSerializer


class EventCentreRetrieveDestroyApiView(generics.RetrieveDestroyAPIView):
    serializer_class = EventCentreSerializer
    queryset = EventCentre.objects.all()
...
class HallsListCreateApiView(generics.ListCreateAPIView):
    queryset = Hall.objects.all()
    serializer_class = HallSerializer
    lookup_field =  'pk'
...
"""
    !!! HALL BOOKINGS VIEWS START
"""
class BookingsListCreateApiView(generics.ListCreateAPIView):
